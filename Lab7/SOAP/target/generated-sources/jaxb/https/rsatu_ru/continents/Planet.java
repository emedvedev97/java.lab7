 ...
 *         &lt;element name="continent" type="{https://rsatu.ru/continents}continentType" maxOccurs="7" minOccurs="7"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
public class Planet {
    ...
    protected List<ContinentType> continents;
    ...
    public List<ContinentType> getContinents() {
        if (continents == null) {
            continents = new ArrayList<ContinentType>();
        }
